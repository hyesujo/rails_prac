...
class ReadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create read" do
    assert_difference('Read.count') do
      post reads_url, params: { read: { content: @read.content, published_at: @read.published_at, title: @read.title, user_id: @read.user_id } }
    end
  ...
  test "should update read" do
    patch read_url(@read), params: { read: { content: @read.content, published_at: @read.published_at, title: @read.title, user_id: @read.user_id } }
